...
disp('Original system loaded (IEEE 14 Bus).');
...
for i = 1 : num_tests
    ...
    % mpc_test.branch(target_tie_line_idx, 3) = 2.2217 * original_resistance;
    % mpc_test.branch(target_tie_line_idx, 4) = 3.3231 * original_reactance;
    mpc_test.branch(target_tie_line_idx, 3) = 2.3380 * original_resistance;
    mpc_test.branch(target_tie_line_idx, 4) = 2.7072 * original_reactance;
    %     mpc_test.branch(target_tie_line_idx, 3) = 1 * original_resistance;
    % mpc_test.branch(target_tie_line_idx, 4) = 2 * original_reactance;
    % 1.5263 2.2435
